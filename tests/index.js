...
describe('tests the iComfort client', () => {
    ...
    describe('updates thermostat settings (setThermostatInfo)', () => {
        ...
        before(async () => {
            ...
            const thermostats = await icomfort.getThermostatInfoList(getThermostatInfoListParams)
                .then(logResponse);
            currentSettings = thermostats.find(thermostat => thermostat.GatewaySN === ENV.GATEWAY_SN);
        });
